...
class MainBmiController extends GetxController {
  ...
  RxInt _age = 30.obs;
  // get - getter - jon ele alip kel
  // set - setter  - ozgoruunu alip kel
  ...
  Rx<Color> activeTus = Color.fromARGB(255, 130, 131, 151).obs;
  Rx<Color> inactiveTus = Color(0xff111327).obs;
